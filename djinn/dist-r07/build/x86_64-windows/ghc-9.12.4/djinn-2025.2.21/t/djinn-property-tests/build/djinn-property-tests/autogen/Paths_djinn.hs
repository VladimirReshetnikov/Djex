...
-- at runtime using the environment variable djinn_bindir.
...
-- environment variable djinn_libdir.
...
-- using the environment variable djinn_dynlibdir.
...
-- runtime using the environment variable djinn_datadir.
...
-- using the environment variable djinn_sysconfdir.
...
bindir     = "C:\\cabal\\bin"
libdir     = "C:\\cabal\\x86_64-windows-ghc-9.12.4-73bf\\djinn-2025.2.21-inplace-djinn-property-tests"
dynlibdir  = "C:\\cabal\\x86_64-windows-ghc-9.12.4-73bf"
datadir    = "C:\\cabal\\x86_64-windows-ghc-9.12.4-73bf\\djinn-2025.2.21"
libexecdir = "C:\\cabal\\djinn-2025.2.21-inplace-djinn-property-tests\\x86_64-windows-ghc-9.12.4-73bf\\djinn-2025.2.21"
sysconfdir = "C:\\cabal\\etc"

getBinDir     = catchIO (getEnv "djinn_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "djinn_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "djinn_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "djinn_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "djinn_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "djinn_sysconfdir") (\_ -> return sysconfdir)
