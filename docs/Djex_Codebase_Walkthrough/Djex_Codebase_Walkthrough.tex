...
\textbf{Snapshot} & \commitid{f50b5eac86726c7530d95e48c27101b7c0fa25c9} \\
\textbf{Prepared} & August 10, 2026 \\
\textbf{Scope} & Shared synthesis foundation, Djinn, Exference, unified facade, source frontends, REPL, tests, and benchmarks. \\
\end{tabularx}
\end{tcolorbox}
\vfill
...
Djex is best understood as a checked semantic perimeter around two synthesis engines. The package contains four large strata:
...
\dpath{exference/src-core/Language/Haskell/Exference/Core/ExpressionCheck.hs} & Independent bidirectional reconstruction, exact schemes, constraints, and rigid scope. \\
...
\midrule
\endhead
\dpath{synthesis/test/Spec.hs} & Shared foundation invariants, lazy-width defenses, alpha/substitution behavior, generated syntax, and selection. \\
...
\dpath{test-api/Spec.hs} and \dpath{test-api/AbstractionBoundary.hs} & Public facade surface, compatibility imports, and hidden-constructor boundaries. \\
...
\begin{itemize}
  \item Pinned tree: \href{https://github.com/VladimirReshetnikov/Djex/tree/f50b5eac86726c7530d95e48c27101b7c0fa25c9}{\nolinkurl{github.com/VladimirReshetnikov/Djex/tree/f50b5eac...}}
