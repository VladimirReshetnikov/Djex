...
retains the complete sealed plan key, closed status, and optional raw value
frame privately, not the already-exercised plan. In a live run raw status bytes
