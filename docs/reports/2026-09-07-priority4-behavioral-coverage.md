...
The [focused introduction milestone](2026-09-08-focused-forall-search.md) accepts all **13 extended
...
The [original Haskell coverage receipt](../../test-church/receipts/priority4-haskell-coverage.json)
preserves the original combined receipt and its two historical audits without
changing their bytes. The [Djinn seven-operation supplement](../../test-church/receipts/priority4-djinn-remaining-seven.json)
...
The [Lean first-six receipt](https://github.com/VladimirReshetnikov/Leant/blob/main/test-church/receipts/priority4-lean-exference-first-six.json) and its [audit](https://github.com/VladimirReshetnikov/Leant/blob/main/test-church/receipts/priority4-lean-exference-first-six-audit.json)
...
fixture failure. The [native-length receipt](https://github.com/VladimirReshetnikov/Leant/blob/main/test-church/receipts/priority4-lean-native-length.json)
...
[failure supplement](../../test-church/receipts/priority4-partial-at-native-int.json) retains these boundaries and adds no
