...
a clean aggregate Leant integration. The [evidence receipt](https://github.com/VladimirReshetnikov/Leant/blob/main/test-church/receipts/post-integration-retriage.json)
