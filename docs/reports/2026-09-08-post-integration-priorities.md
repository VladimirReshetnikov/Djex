...
The [new evidence receipt](https://github.com/VladimirReshetnikov/Leant/blob/main/test-church/receipts/search-failures-retriage.json) retains the complete failed integration run,
timing probes, rejected experiment, tree queries, candidate graphs, compiler
checks and runtime hashes. The [earlier acceptance receipt](https://github.com/VladimirReshetnikov/Leant/blob/main/test-church/receipts/post-integration-retriage.json) preserves
...
The [portable tree fixture](https://github.com/VladimirReshetnikov/Leant/blob/main/test-recursive/tree-accumulator/README.md) records the original provider inventory,
