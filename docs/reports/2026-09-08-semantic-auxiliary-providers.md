...
The [evidence receipt](https://github.com/VladimirReshetnikov/Leant/blob/main/test-context/receipts/semantic-auxiliary-providers.json) retains exact emitted programs, inventories,
...
The [previous receipt's erratum](https://github.com/VladimirReshetnikov/Leant/blob/main/test-church/receipts/search-failures-retriage.erratum.json) corrects the earlier claim that
...
The [discovery runner](https://github.com/VladimirReshetnikov/Leant/blob/main/test-context/run_provider_inventory.py) compiles the actual production generator and
checks its emitted Lean inventories with the production Haskell parser. The
[tree fixture](https://github.com/VladimirReshetnikov/Leant/blob/main/test-recursive/tree-accumulator/README.md) retains the original type, 16 observations, fold-only value
