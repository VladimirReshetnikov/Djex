...
[evidence receipt](https://github.com/VladimirReshetnikov/Leant/blob/main/test-recursive/receipts/tree-carrier-retriage.json) and
its [archive](https://github.com/VladimirReshetnikov/Leant/blob/main/test-recursive/receipts/tree-carrier-retriage.zip) retain the
