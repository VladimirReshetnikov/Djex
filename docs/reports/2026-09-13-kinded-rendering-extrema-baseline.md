...
The [rendering fixtures](../../test-church/source_scope_rendering.hs) cover higher-kinded identity, a vacuous higher-kinded binder, a nested callback, implicit outer quantification, two higher-kinded parameters, successive leading foralls, a constrained outer scope and nested shadowing. The actual emitted module compiles with GHC and executes to:
