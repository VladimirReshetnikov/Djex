...
| `Language.Haskell.Synthesis.Semantic.Length.Problem` | Atomic checked sessions binding one annotation-erased exact neutral inventory, spine model, provider-law table, and a distinct solver-neutral encoding-policy identity; concrete candidate/problem sealing remains fail-closed until interpretation. |
